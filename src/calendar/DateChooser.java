...
public final class DateChooser extends JPanel {
    ...
    private void execute() {
        setForeground(new Color(39,162,187));
    ...
    private void initComponents() {
        ...
        header = new PanelRound();
        cmdForward = new ButtonDate();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new ButtonDate();
        lb = new javax.swing.JLabel();
        cmdYear = new ButtonDate();
        cmdPrevious = new ButtonDate();
        slide = new Slider();

        setBackground(new java.awt.Color(255, 255, 255));

        header.setBackground(new Color(39,162,187));
        header.setMaximumSize(new Dimension(300, 40));

        cmdForward.setCursor(new Cursor(java.awt.Cursor.HAND_CURSOR));
        cmdForward.setIcon(new ImageIcon("./Images/forward.png")); // NOI18N
        ...
        cmdPrevious.setIcon(new ImageIcon("./Images/previous.png")); // NOI18N
    ...
    private ButtonDate cmdForward;
    private ButtonDate cmdMonth;
    private ButtonDate cmdPrevious;
    private ButtonDate cmdYear;
